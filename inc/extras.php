 ...
 */
function kgbtexas__categorized_blog() {

	$category_count = get_transient( 'kgbtexas__categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'kgbtexas__categories', $category_count );
	}
 ...
 */
function kgbtexas__get_attachment_id_from_url( $attachment_url = '' ) {
 ...
 * @return string
 */
function kgbtexas__get_placeholder_image( $args = array() ) {
	$default_args = array(
		'width'            => '',
		'height'           => '',
	...
	if ( ! is_numeric( $width ) ) {
		throw new Exception( esc_html__( 'Width must be an integer', 'kgbtexas' ) );
	}

	if ( ! is_numeric( $height ) ) {
		throw new Exception( esc_html__( 'Height must be an integer', 'kgbtexas' ) );
	}

	if ( ! ctype_xdigit( $background_color ) ) {
		throw new Exception( esc_html__( 'Please provide a valid hex color value for background_color', 'kgbtexas' ) );
	}

	if ( ! ctype_xdigit( $text_color ) ) {
		throw new Exception( esc_html__( 'Please provide a valid hex color value for text_color', 'kgbtexas' ) );
	}
	...
	$alt = apply_filters( 'kgbtexas__placeholder_image_alt', esc_html__( 'WebDevStudios Placeholder Image', 'kgbtexas' ) );
 ...
 * @return string
 */
function kgbtexas__get_placeholder_unsplash( $args = array() ) {
	$default_args = array(
		'width'    => '',
		'height'   => '',
		'category' => '',
 ...
 * @return string
 */
function kgbtexas__display_customizer_header_scripts() {

	// Check for header scripts.
	$scripts = get_theme_mod( 'kgbtexas__header_scripts' );
 ...
 * @return string
 */
function kgbtexas__display_customizer_footer_scripts() {

	// Check for footer scripts.
	$scripts = get_theme_mod( 'kgbtexas__footer_scripts' );
