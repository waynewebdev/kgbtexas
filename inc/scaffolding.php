 ...
 */
function kgbtexas__display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = kgbtexas__scaffolding_allowed_html();
	...
	<div class="scaffolding-document <?php echo esc_attr( $class ); ?>">
		...
		<header class="scaffolding-document-header">
			...
			<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'kgbtexas' ); ?></button>
		...
		<div class="scaffolding-document-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'kgbtexas' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'kgbtexas' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'kgbtexas' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'kgbtexas' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'kgbtexas' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function kgbtexas__scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function kgbtexas__display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function kgbtexas__hook_theme_scaffolding() {
...
add_action( 'kgbtexas__scaffolding_content', 'kgbtexas__hook_theme_scaffolding' );
