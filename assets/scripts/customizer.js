...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-kgbtexas__header_button select' ),
			headerLinkButton: $( '#customize-control-kgbtexas__header_button_url' ),
			headerLinkText: $( '#customize-control-kgbtexas__header_button_text' )
		};
	};
